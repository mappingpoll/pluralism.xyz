...
const xSlider = document.querySelector(".vslider"):
const ySlider = document.querySelector(".hslider"):
...
} = referenceGeometryFns(xSlider);

const ondrag = event => {
  handle.style.top = `${event.clientY}`;
};
