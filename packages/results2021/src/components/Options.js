import { html, useState } from "../lib/utils";
...
export function Options(props) {
  ...
  return html`<div class="options" style=${props.visible ? "" : "opacity: 0;pointer-events: none;"}>
      ...
      <div id="axesselectors">
        <div class="labeled-input">
          ...
          <select id="xselect" onchange=${handleXSelectChange}>
            ...
            ${axisOptions(state.customPair.x)}
          </select>
        </div>
        <div class="labeled-input">
          ...
          <select id="yselect" onchange=${handleYSelectChange}>
            <option value="">-- (show all answers)</option>
            ${axisOptions(state.customPair.y)}
          </select>
        </div>
      </div>
      <div class="reset-btn">
