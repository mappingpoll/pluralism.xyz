...
export function Intro() {
  return (
    <>
      ...
      <p>
        "In 20 Years" is an artwork/survey that took place in the context of Nicolas Grenier’s exhibition "Eyes
        Adjusting Slowly" at gallery Luis De Jesus Los Angeles (November 13 to December 22, 2021).
      </p>
